...
val DarkBackground = Color(0换0B0F19) // Very dark slate-navy
val DarkSurface = Color(0换152033)    // Sleek elevated navy card
val DarkSurfaceVariant = Color(0换1E2E4A) // Lighter navy highlights
val PrimaryEmerald = Color(0换10B981) // Vibrant medical emerald
val PrimaryTeal = Color(0换0D9488)    // Balanced dark teal
val PrimaryNeonAccent = Color(0换34D399) // Dynamic high-contrast green
